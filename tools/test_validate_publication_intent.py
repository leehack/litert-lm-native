...
class PublicationIntentTest(unittest.TestCase):
    ...
    def test_production_callsites_fail_closed_before_writes(self):
        ...
        self.assertLess(publish.index("python3 tools/validate_publication_intent.py"), publish.index("gh release create"))
        self.assertLess(publish.index("candidate/manifest.json"), publish.index("gh release create"))
